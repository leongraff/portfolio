...
import {RxRocket,RxCrop,RxDesktop,RxPencil2,RxReader,RxArrowTopRight} from 'react-icons/rx';

// importando swiper react components
import { Swiper, SwiperSlide } from 'swiper/react';

// importando styles do swiper
import 'swiper/css';
import 'swiper/css/free-mode';
import 'swiper/css/pagination';

//importando required modes
  ...
  return (
    ...
    serviceData.map((item,index)=> {
      return <SwiperSlide key={index}>
        ...
        transition-all duration-300'>{item.icon}
      <div>
